    ...
    <section className="bg-gradient-to-r from-green-500 to-green-800">
      <div className="flex justify-center h-screen">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.pexels.com/photos/2132250/pexels-photo-2132250.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1&auto=format&fit=crop&w=1470&q=80)",
          }}
        >
          <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
            <div>
              ...
              <p className="max-w-xl text-lg mt-3 text-white font-bold">
                ...
                buyers, providing secure contracts for agricultural produce. It
                reduces market risks, stabilizes incomes, and fosters
                transparency and trust between farmers and buyers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
          <div className="flex-1">
            ...
            <div className="mt-8">
              <form>
                <div>
                  <label for="email" className="block mb-2 text-white text-lg">
                    Email Address
                  </label>
                  <input
                    type="email"
                ...
                <div className="mt-6">
                  <div className="flex justify-between mb-2">
                    <label for="password" className="text-lg text-white">
                      Password
                    </label>
                    <a
                      href="#"
              ...
              <p className="mt-6 text-lg text-center text-white">
                ...
                <a
                  href="/signup"
                  className="text-gray-700 focus:outline-none focus:underline hover:underline"
                >
                  Sign up
                </a>
                .
